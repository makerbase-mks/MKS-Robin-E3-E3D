...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_MKS_ROBIN_E3D //BOARD_MKS_ROBIN_E3_V1_1
#endif
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -42, -11.5, 0 }
...
#define HOMING_FEEDRATE_MM_M { (4*20*60), (4*20*60), (2*4*60) }
